...
export const Operator = (): JSX.Element => {
  ...
  //                 size: 10,
  //             });
  //             const resp = await fetchOperators(queryString);
  //             const respData = resp?.data;
  //             if(respData?.data) {
  //                 setMetadata(respData?.data);
  //                 setOperators(respData?.data?.data);
  //             }
  //         }
  //     })();
  // }, [operators])
                        ...
                        <div className="bg-white rounded-xl border border-gray-20">
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead className="bg-gray-5">{/* ...same as your current columns... */}</thead>
                                    <tbody>
